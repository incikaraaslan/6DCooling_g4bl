...
cols = [0,1,3,4,12]  # 0-indexed for region, z, emittanceperp, emittancelong
...
plt.show()
plt.plot(data_final[:,1],data_final[:,4]/data_final[0,4]*100, color='black', label = "With Fringe Fields")
plt.plot(data_final2[:,1],data_final2[:,4]/data_final2[0,4]*100, color='red', label = "Without Fringe Fields")
plt.xlabel("z [m]")

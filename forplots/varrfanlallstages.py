...
if __name__ == "__main__":
    ...
    parser.add_argument("--stdev", type=float, default=2.34,  help="Offset Stdev [MV/m]" )
    ...
    plt.plot(z_last, np.asarray(eperp_noerrl).flatten(), color = "red", label = "B1-B10 without any errors")
    ...
    plt.savefig("./allstvarrfgradphtol_eperp"+"_sample-size_" + str(args.sample_size) +"_"+str(args.number_of_particles) + "_"+str(args.stdev)+"_"+str(args.stdev_phase)+".png", transparent = True)
    plt.close()
    ...
    plt.plot(z_last, np.asarray(elong_noerrl).flatten(), color = "red", label = "B1-B10 without any errors")
    ...
    # plt.grid(True)
    plt.legend(loc='best',framealpha=0.8)
    plt.savefig("./allstvarrfgradphtol_elong"+"_sample-size_" + str(args.sample_size) +"_"+str(args.number_of_particles)+"_"+str(args.stdev)+"_"+str(args.stdev_phase)+".png", transparent = True)
    plt.close()
    ...
    plt.plot(z_last, np.asarray(e6d_noerrl).flatten(), color = "red", label = "B1-B10 without any errors")
    ...
    plt.grid(True)
    plt.legend(loc='best',framealpha=0.8)
    plt.savefig("./allstvarrfgradphtol_e6d"+"_sample-size_" + str(args.sample_size) +"_"+str(args.number_of_particles)+"_"+str(args.stdev)+"_"+str(args.stdev_phase)+".png", transparent = True)
    plt.close()
    ...
    plt.plot(z_last, np.asarray(trans_noerrl).flatten(), color = "red", label = "B1-B10 without any errors")
    ...
    # plt.grid(True)
    plt.legend(loc='best',framealpha=0.8)
    plt.savefig("./allstvarrfgradphtol_trans"+"_sample-size_" + str(args.sample_size) +"_"+str(args.number_of_particles) +"_"+str(args.stdev)+"_"+str(args.stdev_phase)+".png", transparent = True)
    plt.close()
...
For the purposes of effectively constructing a 10 TeV center-of-mass Muon Collider, it is crucial to have a cooling section where the goal is to rapidly decrease muon beam emittance to reach the desired luminosity for the eventual $\mu^+$ and $\mu^-$ collision in the ring. 

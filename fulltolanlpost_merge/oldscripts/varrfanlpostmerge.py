...
from varrfanlsinglestage import singleStage
import re
import glob
...
if __name__ == "__main__":
    ...
    for i, filename in enumerate(file_list):
        ...
        print(noerr_list[i])
        singleStage(filename, mean, stdev, meanp, stdevp, args.sample_size, ncavities, ncells, args.number_of_particles, noerr_list[i],i)
